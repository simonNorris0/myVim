" Name:         hidesert
" Description:  A better version of desert.
" Author:       Original author Hans Fugal <hans@fugal.net>
"               Edited by Simon Norris
" Maintainer:   Original maintainer Hans Fugal <hans@fugal.net>
" Website:      https://github.com/vim/colorschemes
" License:      Same as Vim
" Last Change:  2025 Mar 20

" Original generated by Colortemplate v2.2.3
...
hi Statement guifg=#00ff00 guibg=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi Statement ctermfg=46 ctermbg=NONE cterm=bold
...
if s:t_Co >= 8
  ...
  hi SpellLocal ctermfg=darkyellow ctermbg=NONE cterm=reverse
  hi SpellRare ctermfg=darkgreen ctermbg=NONE cterm=reverse
  hi Comment ctermfg=red ctermbg=NONE cterm=bold
